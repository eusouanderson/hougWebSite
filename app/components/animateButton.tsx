...
const AnimateButton = ({ setIsOpen }: any) => {
    ...
    const textContent = "Criar minha estampa";
    ...
    return (
        <div ref={sectionRef} className="flex flex-col justify-center items-center scale-150">
            <svg width="244" height="84" viewBox="0 0 244 84" fill="none" xmlns="http://www.w3.org/2000/svg" ref={scope} onClick={handleClick} className="cursor-pointer">
                <circle id="blue-circle" cx="121.5" cy="40.5" r="0" fill="#101010" />
                ...
                <g style={{ transform: gTransform, transition: "transform 0.5s cubic-bezier(0.5, 1.25, 0.3, 1)" }}>
                    <circle id="blue-inner-circle" cx="121.528" cy="40.4722" r="0" fill="#101010" opacity="0" />
                    <path
                        id="plus-sign"
